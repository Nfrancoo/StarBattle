...
from enemigos.Boss import Boss
...
class NivelCuatro(Nivel):
    def __init__(self, pantalla):
        ...
        clock = pygame.time.Clock()
         ...
         # Cargar musica
        pygame.mixer.music.load("proyecto/audio\musica\sport-metal-90-bpm-loop-13726.mp3")
        ...
        img_fondo = load_images('proyecto/fondos/muelle_background')
        ...
        enemigo_sheet = pygame.image.load('proyecto/sheets_enemigo/futurista.png')

        # Cargar sonido ataque
        fut_son = pygame.mixer.Sound("proyecto/audio\efecto de sonido\lightsaber-turn-on.mp3")
