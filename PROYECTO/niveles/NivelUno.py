...
class NivelUno(Nivel):
    def __init__(self, pantalla):
        ...
        # Cargar musica
        pygame.mixer.music.load("proyecto/audio\musica\music.mp3")
        ...
        img_fondo = pygame.image.load('proyecto/fondos/imagenes/69.webp')
        background = 'SA'
        all_sprites = 'SA'
        ...
        enemigo_sheet = pygame.image.load('proyecto/sheets_enemigo/espadachin.png')

        # Cargar sonidos golpes
        warrior_son = pygame.mixer.Sound("proyecto/audio\efecto de sonido\sword.wav")
        warrior_son.set_volume(0.5)
        espadachin_son = pygame.mixer.Sound("proyecto/audio\efecto de sonido\sword.wav")
