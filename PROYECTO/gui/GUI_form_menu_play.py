...
from gui.GUI_manejador_niveles import ManejadorNiveles
...
class formNiveles(Form):
    def __init__(self, screen, x, y, w, h, color_background, color_border, active, path_image):
        ...
        self.niveles_imagenes = {
            "nivel_uno": "proyecto/fondos\imagenes\primerpelea.png",
            "nivel_dos": "proyecto/fondos\imagenes\peleados.png",
            "nivel_tres": "proyecto/fondos\imagenes/tercerpelea.png",
            "nivel_cuatro": "proyecto/fondos\imagenes\cuartonivel.png"
        }
        ...
        self.btn_nivel_uno = Button_Image(screen=self._slave,
                                          ...
                                          w=100,
                                          h=100,
                                          path_image="proyecto/fondos\imagenes/nivel_uno.png",
        ...
        self.btn_nivel_dos = Button_Image(screen=self._slave,
                                          ...
                                          w=100,
                                          h=100,
                                          path_image="proyecto/fondos\imagenes/nivel_dos.png",
                                          onclick=self.entrar_nivel,
        ...
        self.btn_nivel_tres = Button_Image(screen=self._slave,
                                          ...
                                          path_image="proyecto/fondos\imagenes/nivel_tres.png",
                                          onclick=self.entrar_nivel,
        ...
        self.btn_nivel_cuatro = Button_Image(screen=self._slave,
                                             ...
                                             color_background=(255, 0, 0),
                                             color_border=(255, 0, 255),
                                             path_image="proyecto/fondos\imagenes/nivel_cuatro.png",
                                             onclick=self.entrar_nivel,
