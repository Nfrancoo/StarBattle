import pygame
import sys
from personajeND import Personaje
from enemigoND import Enemigo
...
personaje_1 = Personaje(1, 200, 280, False, WARRIOR_DATA, warrior_sheet, WARRIOR_ANIMACION_PASOS,)
...
while True:
    ...
    for dona in lista_donas:
        if dona['rectangulo'].colliderect(personaje_1.rect):
            ...
            if personaje_2.vida < 100:  # Permitir que la vida alcance 100
                personaje_2.vida += 5
